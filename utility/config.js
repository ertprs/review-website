...
export const thirdPartyDataApi = "/api/my-business/profile/third-party-data";
export const fetchProfileReviewsApi = "/api/reviews/domain";
...
export const configuredReviewPlatformsApi = "/api/review-platforms";
