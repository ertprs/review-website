        ...
        <div className="reviewCard">
            ...
            <div className="row topBox">
                ...
                <div className="col-md-6">
                    <div>
                        <div>
                            <span className="cardLink">This will be any link!!</span><br />
                            <span>Any sub text</span>
                        </div>
                        <p className="source">Source: <span>Organic</span></p>
                    </div>
                </div>
            ...
            <div className="row bottomBox">
                ...
                <div className="col-md-9">
                    <div className="bottomBoxInner">
                        ...
                        <div className="footerLinks">
                            <p><i className="fa fa-share-alt icons"></i>Share</p>
                        </div>
                        <div className="footerLinks">
                            <p><i className="fa fa-search icons"></i>Find Reviewer</p>
                        </div>
                        <div className="footerLinks">
                            <p><i className="fa fa-flag icons"></i>Report</p>
                        </div>
                    </div>
                </div>
                <div className="col-md-1"></div>
