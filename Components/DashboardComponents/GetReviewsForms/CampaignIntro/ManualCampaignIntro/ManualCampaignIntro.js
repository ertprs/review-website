...
function getSteps() {
  return [
    ...
    "Choose manual method to add customers to invite",
...
function getStepContent(step) {
  switch (step) {
    case 0:
      return `For each review campaign that you create, in the first step you need to enter the campaign name, select your campaign language(English/Latvia.., etc), enter the sender name and select your invitation type (automatic or manual).`;
    case 1:
      return "You get the options to add your customer details (customer name and customer email), the first option allows you to upload your customer details via a CSV file, the second option allows you to copy and paste yor customers data and the last option allows you to enter your customers data manually in textboxes";
    case 2:
...
class ManualCampaignIntro extends Component {
  state = {
    activeStep: 0
  };
  ...
  render() {
    ...
    return (
      <div className="manualInfoContainer">
        <style jsx>
          {`
            .manualInfoContainer {
        ...
        <div className="header">
          <h4>Manual Invitations</h4>
        </div>
        <div className="subHeader">
          <h6>
            Invite your customers manually :
          </h6>
        </div>
        <div className="list">
...
export default withStyles(styles)(ManualCampaignIntro);
